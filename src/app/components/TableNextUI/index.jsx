import { Pagination, Select, SelectItem, Spinner, Table, TableBody, TableCell, TableColumn, TableHeader, TableRow } from "@nextui-org/react";
...
function TableNextUI({ 
    ...
    }, [total, pageSize, page, onPageChange, onPageSizeChange, selectionMode, selectedKeys]);
			...
			<TableHeader columns={columns}>
				{(column) => (
					<TableColumn
						key={column._id}
						className={`${
							column._id === "actions" && "w-36 text-center"
						}`}
